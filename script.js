...
// Create an instance Car parameters -> (model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof)
...
// Create an instance  Sport. parameters (model, trim, transmission, top, color, seatstrim, audio, wheelstrim)
...
const miataRf = new Sport('Miata-RF', 'Grand Touring', 'manual', 'hard top', 'red', 'leather', 'premium')
...
// The Trail Blazer should inherit from truck.  parameters (model, color, enginesize, hitch, bed, navigation)
...
trailBlazer.warranty = '150,000 miles / 6 years'

console.log(trailBlazer.model)
